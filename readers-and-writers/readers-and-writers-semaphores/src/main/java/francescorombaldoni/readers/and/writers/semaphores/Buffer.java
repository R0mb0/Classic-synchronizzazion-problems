...
class Buffer {
     ...
     */
    public Buffer(int bufferLength, boolean fifoSemaphores){
        if(bufferLength <= 0){
        ...
        this.emptyBuffer = new Semaphore(0, fifoSemaphores);
        this.reading = new Semaphore(0, fifoSemaphores);
     ...
     */
    public Buffer(boolean randomBuffer, boolean fifoSemaphores){
        if(!randomBuffer){
